...
the system prompt — not the model or the loop — drove the quality gap.
...
**What it deliberately omits** (and why that matched the benchmark):
...
**Bottom line:** looplet's coder prompt is a genuinely competitive,
...
why it ties on coding and trails on open-ended prose; both are consequences
