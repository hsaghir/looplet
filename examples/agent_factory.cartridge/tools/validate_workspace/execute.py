...
def execute(
    ...
    *,
    ...
    from looplet import cartridge_to_preset  # noqa: PLC0415
    from looplet.cartridge import CartridgeSerializationError  # noqa: PLC0415

    try:
        preset = cartridge_to_preset(str(abs_path), strict=strict)
        ...
        return {
            "error": f"CartridgeSerializationError: {exc}",
            "kind": "serialization",
            "recovery": (
