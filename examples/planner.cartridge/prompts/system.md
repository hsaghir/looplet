...
1. Call `subagent` with `workspace="examples/planner.cartridge/planner_child.cartridge"`
...
(parent + child + subagent), not a *loop feature*. Anyone who wants
plan mode in their own agent writes the same five lines.
