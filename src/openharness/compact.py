...
class TruncateCompact:
    ...
    :func:`openharness.scaffolding.emergency_truncate`.
    ...
    def compact(
        ...
        *,
        ...
        # Session-log side.
        from openharness.scaffolding import emergency_truncate  # noqa: PLC0415
...
def _emit_compact_event(
    ...
    *,
    ...
    Kept inline to avoid importing from :mod:`openharness.loop` (that
...
class SummarizeCompact:
    ...
    def compact(
        ...
        *,
        ...
        from openharness.scaffolding import (  # noqa: PLC0415
            emergency_truncate,
            llm_call_with_retry,
        )
        ...
        if summary_text and hasattr(session_log, "entries"):
            try:
                from openharness.session import LogEntry  # noqa: PLC0415
...
class PruneToolResults:
    ...
    web_fetch; openharness lets you decide.
    """
    ...
    def compact(
        ...
        *,
        ...
        from openharness.conversation import MessageRole  # noqa: PLC0415
