...
Wraps tools from an MCP server as openharness :class:`ToolSpec` instances
...
class MCPToolAdapter:
    """Adapt an MCP server's tools into openharness ToolSpecs.
    ...
    def _ensure_started(self) -> None:
        ...
        init_resp = self._send_request("initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "openharness", "version": "0.1"},
        })
